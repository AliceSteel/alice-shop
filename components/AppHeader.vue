<template>
  ...
  >
    <nuxt-link
      ...
      title="Homepage"
    >
      <img src="../assets/logo/logo1.png" alt="logo" class="h-full" />
      ...
      >
        <g>
          <g>
            <path
              style="fill: #333333"
              d="M271.903,37.875h-45.834c-8.489-21.905-29.733-37.5-54.6-37.5c-8.316,0-16.214,1.767-23.386,4.903
            ...
            <g>
              <polygon
                style="fill: #f9ba48"
                points="248.813,183.188 112.875,183.188 108.188,126.938 244.125,126.938 			"
              />
            </g>
          </g>
        </g>
